...
export default function Project() {
    ...
    const onTrialByTshirt = () => {
        window.open("https://www.trialbytshirt.com/", "_blank")
    }
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-1 md:pl-60 lg:gap-5 lg:p-15 p-10 lg:pl-30">
                ...
                <div className="text-white lg:py-0 py-5">
                    <div className="border rounded-md border-gray-700 bg-gray-900 overflow-hidden w-full max-w-[380px]">
                        ...
                        <div className="relative w-full h-[220px] overflow-hidden bg-gray-200 rounded-lg shadow-xl flex justify-center items-start">
                            <iframe
                                src="https://www.trialbytshirt.com/"
                                title="Trial By Tshirt"
                                className="absolute top-0 left-0 w-[1740px] h-[1100px] origin-top-left scale-[0.22] border-none rounded-md"
                                loading="lazy"
                            />
                        </div>
                        <div className="p-4">
                            <div className="flex justify-between items-center">
                                <h1 className="text-xl font-bold">Trial By Tshirt</h1>
                                <FiExternalLink className="cursor-pointer" onClick={onTrialByTshirt} />
                            </div>
                            <p className="text-left text-sm text-gray-400 pt-1 cursor-pointer hover:underline" onClick={onTrialByTshirt}>
                                trialbytshirt.com
                            </p>
                            <div className="text-left flex flex-wrap gap-1 pt-3">
                                <div className="inline-flex items-center bg-gray-700 px-2 gap-2">
                ...
                <div className="text-white lg:py-0 py-5">
                    <div className="border rounded-md border-gray-700 bg-gray-900 overflow-hidden w-full max-w-[380px]">
                        <div className="relative w-full h-[220px] overflow-hidden bg-gray-200 rounded-lg shadow-xl flex justify-center items-start">
                            <iframe
                                src="https://chaminiseek.vercel.app/"
                                title="Chaminiseek"
                                className="absolute top-0 left-0 w-[1740px] h-[1100px] origin-top-left scale-[0.22] border-none rounded-md"
                                loading="lazy"
                            />
                        ...
                        <div className="p-4">
                            <div className="flex justify-between items-center">
                                ...
                                <FiExternalLink className="cursor-pointer" onClick={onChaminiseek} />
                            </div>
                            ...
                            <div className="text-left flex flex-wrap gap-1 pt-3">
                                ...
                                <div className="inline-flex items-center bg-gray-700 px-2 gap-2">
                                    ...
                                    <p className="text-sm">AI Integrated</p>
                                </div>
